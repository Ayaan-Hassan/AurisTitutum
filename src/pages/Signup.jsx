    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-bg-main">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          <Link
            to="/"
            className="inline-flex items-center gap-3 mb-10 cursor-pointer group"
          >
          ...
          <p className="text-xs text-text-secondary uppercase tracking-[0.3em] font-mono">
            Create Your Account
          </p>
        </div>
            ...
            {error &&
              ...
              !error.includes("Weak") && (
                <div className="p-3 bg-danger/10 border border-danger/20 rounded-xl">
                  <p className="text-[10px] text-danger font-bold uppercase tracking-widest leading-tight">
                    {error}
                  </p>
                </div>
              )}
